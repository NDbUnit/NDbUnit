...
USE [testdb]
GO
/****** Object:  Table [dbo].[User]    Script Date: 12/14/2009 23:16:02 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Role]    Script Date: 12/14/2009 23:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[UserRole]    Script Date: 12/14/2009 23:16:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  ForeignKey [FK_User_Supervisor]    Script Date: 12/14/2009 23:16:02 ******/
...
GO
/****** Object:  ForeignKey [FK_UserRole_Role]    Script Date: 12/14/2009 23:16:02 ******/
ALTER TABLE [dbo].[UserRole]  WITH NOCHECK ADD  CONSTRAINT [FK_UserRole_Role] FOREIGN KEY([RoleID])
REFERENCES [dbo].[Role] ([ID])
GO
ALTER TABLE [dbo].[UserRole] CHECK CONSTRAINT [FK_UserRole_Role]
GO
/****** Object:  ForeignKey [FK_UserRole_User]    Script Date: 12/14/2009 23:16:02 ******/
