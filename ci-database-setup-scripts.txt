...
psql --user=postgres --no-password --command="CREATE DATABASE testdb;"
psql --user=postgres --no-password --dbname=testdb --file="%APPVEYOR_BUILD_FOLDER%\NDbUnit.Test\Scripts\postgres-testdb-create.sql"
